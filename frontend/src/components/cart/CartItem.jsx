  ...
  return (
    <div className='flex justify-between max-h-max  border-b-black/10 p-2 sm:p-4 relative'> 
        ...
        <div className=' flex gap-x-4  w-full '>
          <img src={product.image} alt="" className='w-[80px]  sm:w-[90px]' /> 
        ...
        <div className='flex flex-col justify-between  h-auto relative'> 
            <div className=' flex justify-end absolute sm:static right-1'><MdDeleteForever className='text-[#ff3333] text-2xl cursor-pointer 'onClick={()=>removeItem(product)} /></div>  
