...
const NewArrival = () => {
    ...
    return (
        <div className='max-w-[80rem] lg:mx-auto my-6 mt-8  rounded-2xl px-2 mx-4'>
            ...
            {/* select styles */}
            <div className='w-full lg:max-w-[80rem] mx-auto  overflow-x-auto hide-scrollbar snap-x '>
                <div className='grid grid-flow-col auto-cols-[200px] lg:auto-cols-[250px] max-w-full gap-x-4  py-4 lg:p-4 mt-4 snap-mandatory'>
                    {
