    ...
    return (
        ...
        >
            <div className='py-4 px-8 space-y-1'>
                <p className='font-semibold'>Md Tauhid</p>
                <p className='text-sm text-black/60'>tauhid@gmail.com</p>
            </div>
            <div className='h-[1px] bg-black/10'></div>
            <div className='p-4 px-8 space-y-4 text-[18px]'>
                <div className='flex items-center gap-x-4'><span><CgProfile className="text-black" /></span> <span>Profile</span></div>
                <div className='flex items-center gap-x-4'><span><svg width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                ...
                <div className='flex items-center gap-x-4'><span><FaLocationDot/></span> <span>Address</span></div>
            </div>
            <div className='p-4 px-8 border-t-1 border-black/10 rounded-2xl flex items-center gap-x-4 text-[18px]'> 
